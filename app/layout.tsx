...
export const metadata: Metadata = {
  title: 'Arisandi Satria Jeujanan | Frontend Developer',
  description: 'Portfolio of Arisandi Satria Jeujanan, a passionate Frontend Developer specializing in React, Next.js, and modern web technologies.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
